...
/**
  * The Botty service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the BottyService.
  */
trait BottyService extends Service {
  ...
  override final def descriptor = {
    ...
    named("botty")
      ...
      .withTopics(
        topic(BottyService.TOPIC_NAME, greetingsTopic)
